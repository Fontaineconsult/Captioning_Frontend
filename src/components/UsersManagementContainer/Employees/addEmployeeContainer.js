            ...
            <div className="addEmployeeContainer emp-top">
                <form onSubmit={this.handleSubmit}>
                    <label htmlFor={"employeeId"}>
                        <div>Employee ID</div>
                        <input className={"emp-input"} maxLength={9} value={this.state.employeeId} type={'text'}
                    ...
                    <label htmlFor={"email"}>
                        <div>E-Mail</div>
                        <input className={"emp-input"} required={true} value={this.state.email} type={'text'}
                               name={"email"} onChange={this.handleChange}/>
                    </label>
                    <label htmlFor={"phoneNumber"}>
                        <div>Phone Number</div>
                        <input className={"emp-input"} value={this.state.phoneNumber} type={'text'} name={"phoneNumber"}
